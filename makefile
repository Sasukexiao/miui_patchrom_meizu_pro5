...
local-out-zip-file := MIUI8_PRO5.zip
...
# All apks from MIUI
local-miui-removed-apps := FM MiLivetalk Mipay WebViewGoogle ThemeManager miuisystem XiaomiAccount

local-miui-modified-apps := TeleService InCallUI SecurityCenter MiuiSystemUI PersonalAssistant Mms XiaomiServiceFramework
